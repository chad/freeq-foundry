 ...
 */
import type { Message, Member, WhoisInfo, ChannelListEntry, AvSession, TransportState, PinnedMessage, GovernancePayload, PresencePayload, CoordinationEventPayload, SpendPayload, BudgetSnapshot, AgentSpawnedPayload, AgentDespawnedPayload } from './types.js';
...
export interface FreeqEvents {
    ...
    membersSync: (channel: string, members: Array<Partial<Member> & {
        nick: string;
    }>) => void;
